...
data,flds=read_data("Adina_harm.dat")
...
#marg=[0,1000,2000,3000,4000,5000,6000]
...
for n_n in range(1,20):
  ...
  for train_index,test_index in kf.split(X):
      ...
      neigh=KNeighborsClassifier(n_neighbors=n_n)
      neigh.fit(X_train,y_train)
      sc = neigh.score(X_test,y_test)
#      print "score=",sc
      s_score+=sc

  print "n_neighbors",n_n,"Mean score=",s_score/n_f
...
#   print n_n,"Mean score=",s_score/n_f
   if s_score/n_f>s_score_max:
       s_score_max=s_score/n_f
       n_n_max=n_n
print "Mean score",n_n_max,s_score_max
